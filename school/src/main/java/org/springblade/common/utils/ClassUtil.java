...
//    }
    ...
    //生成不重复随机数
    public static List randomTime3() {

		int[] fixedArrays = new int[70];
		int[] resArrays = new int[70];
		...
		System.out.println(Arrays.toString(resArrays));
		List<Integer> list = new ArrayList<>();
		for (int number:resArrays){
			list.add(number);
		}
    ...
    private static int calculateMainExpect(String classTime) {
        ...
        String[] tenExpectValue = {"01", "05", "08", "11", "15","18","21","25","28","31","35","38","41","45","48","51","55","58","61","65","68"};
        // 主要课程期望值为8时的时间片值
        String[] eightExpectValue = {"02", "06", "09", "12", "16","19","22","26","29","32","36","39","42","46","49","52","56","59","62","66","69"};
        // 主要课程期望值为4时的时间片值
        String[] fourExpectValue = {"03", "07", "10", "13", "17","20","23","27","30","33","37","40","43","47","50","53","57","60","63","67","70"};
        // 主要课程期望值为2时的时间片值
        String[] twoExpectValue = {"04", "08", "11", "14", "18","21","24","28","31","34","38","41","44","48","51","54","58","61","64","68"};
        // 主要课程期望值为0时的时间片值
    ...
    private static int calculateSecondaryExpect(String classTime) {
        // 次要课程期望值为10时的时间片值
        String[] tenExpectValue = {"03", "07", "10", "13", "17","20","23","27","30","33","37","40","43","47","50","53","57","60","63","67","70"};
        // 次要课程期望值为8时的时间片值
        String[] eightExpectValue = {"04", "08", "11", "14", "18","21","24","28","31","34","38","41","44","48","51","54","58","61","64","68"};
        // 次要课程期望值为4时的时间片值
        String[] fourExpectValue = {"02", "06", "09", "12", "16","19","22","26","29","32","36","39","42","46","49","52","56","59","62","66","69"};

        String[] twoExpectValue = {"01", "05", "08", "11", "15","18","21","25","28","31","35","38","41","45","48","51","55","58","61","65","68"};
    ...
    private static int calculatePhysicalExpect(String classTime) {
        String[] tenExpectValue = {"5","6","7","15","16","17","25","26","27","35","36","37","45","46","47","55","56","57","65","66","67",};//体育课期望值为10时的时间片值  24
    ...
    private static int judgingDiscreteValues(int temp) {
        int[] tenExpectValue = {1,4,5,10,20}; // 期望值为10时两课之间的时间差
        int[] sixExpectValue = {3,6}; // 期望值为6时两课之间的时间差
        int[] fourExpectValue = {7,8}; // 期望值为4时两课之间的时间差
        int[] twoExpectValue = {2,9}; // 期望值为2时两课之间的时间差
    ...
    public static double calculatExpectedValue(List<String> individualList) {
        ...
        double K2 = 0.2; // 次要课所占权重
        double K3 = 0.1; // 体育课所占权重
        double K4 = 0.1; // 信息技术课所占权重
        ...
        for (String gene : individualList) {
            ...
            } else if(courseAttr.equals(ConstantInfo.TECHNOLOGY_COURSE)){
